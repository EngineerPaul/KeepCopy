"""Генерация true_prompt.docx — промпт для воссоздания идентичного Архиватора."""
...
def _add_title_page(doc: Document) -> None:
    ...
    meta.add_run(
        ...
        "Источник: актуальный код проекта Archiver"
    )
...
def build_document() -> Document:
    ...
    doc.add_paragraph(
        "Создай настольное Windows-приложение «Архиватор» строго по этому ТЗ. "
    ...
    doc.add_paragraph(
        "Архиватор — приложение для ручного и периодического резервного копирования "
        "файлов и каталогов. Пользователь задаёт источники, папку назначения (архив), "
    ...
    _add_table(
        ...
        [
            ...
            ["Тесты", "pytest"],
            ["Сборка", "Nuitka → compiler/Archiver.dist/"],
        ],
    )
    ...
    for term, definition in [
        ("Задача", "Настроенное копирование: источники, архив, расписание, режим, сжатие."),
        ("Источник", "Файл или папка; в задаче может быть несколько."),
        ("Архив", "Существующая папка назначения (с буквой диска)."),
    ...
    _bullets(
        doc,
        [
            "Иконка «Архиватор»; меню: «Открыть», «Выход».",
    ...
    doc.add_paragraph("Заголовок «Архиватор». Панель инструментов | таблица задач | строка статуса.")
    _add_table(
        doc,
        ["Кнопка", "Поведение"],
        [
    ...
    _add_table(
        ...
        [
            ...
            ["destination", "Архив", "да", "160", "elide; открытие в проводнике"],
    ...
    _bullets(
        doc,
        [
            "Двойной клик / ПКМ по «Источники» или «Архив» — открыть в проводнике (несколько источников — меню).",
            "Горизонтальный скролл: Alt + колёсико.",
            "Подсказка строки: HTML с названием, архивом (акцент) и всеми источниками.",
    ...
    _add_table(
        ...
        [
            ...
            [
                "Источники",
                "≥1; папка или файл; таблица с удалением; вложенные пути красным и НЕ сохраняются",
            ],
            ["Путь вставки", "Существующая папка с буквой диска"],
            ...
            ["Архивирование", "ZIP_DEFLATED, compresslevel=5"],
    ...
    doc.add_heading("6.1. Именование в архиве", level=2)
    _bullets(
        doc,
        [
    ...
    _add_table(
        ...
        [
            [
                ...
                "Ручной запуск также копирует файлы, отсутствующие в архиве. "
    ...
    doc.add_paragraph("Рядом с main.py / Archiver.exe. Структура:")
    code = (
        "{\n"
        '  "tasks": [ { /* поля Task */ } ],\n'
        '  "settings": {\n'
    ...
    _add_table(
        ...
        [
            ...
            ["Ярлык", "Archiver.lnk"],
            ["Цель (exe)", "Archiver.exe --background"],
    ...
    _bullets(
        ...
        [
            ...
            "Выход: compiler/Archiver.dist/ (переименовать из main.dist); сохранять settings.json при пересборке.",
            "main.build — промежуточная папка; для работы exe не нужна; ускоряет повторные сборки — не удалять скриптом по умолчанию.",
            "Антивирус может ложно блокировать (Bearfoos.A!ml) — исключить всю папку Archiver.dist.",
        ],
    )
    ...
    for i, c in enumerate(
        [
            ...
            "Сборка Nuitka в Archiver.dist — по §12.",
    ...
    _bullets(
        ...
        [
            ...
            "Ручной keep_changes копирует и «пропавшие» в архиве файлы.",

...
<p><b>Режимы.</b> «Сохранять изменения» — только новые и изменённые файлы. «Сохранять слоями» — каждый запуск создаёт новый слой backup_ДД.ММ.ГГГГ_NNN. «Дублирование» — полная копия в новый слой.</p>
...
<p><b>Таблица.</b> Клик по строке раскрывает список источников и исключений. Кнопки в колонке «Действия»: активация, редактирование, удаление. Для горизонтальной прокрутки зажмите Alt и прокрутите колёсико мыши.</p>

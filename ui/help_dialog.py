...
HELP_TEXT = f"""
<h2>{APP_NAME} — краткая справка</h2>

<p><b>Создание задачи.</b> Нажмите «Создать», укажите название, один или несколько источников и папку назначения. Добавьте исключения при необходимости. Выберите режим копирования и нажмите «Сохранить».</p>

<p><b>Источники.</b> В папке назначения для каждой исходной папки создаётся подпапка с её именем; для отдельного файла — подпапка «имя_родительской_папки_files». Несколько источников добавляются кнопкой «+».</p>
...
<p><b>Таблица.</b> Клик по строке раскрывает список источников и исключений. Правый клик по пути в колонках «Источники» или «Назначение» открывает эту директорию в проводнике. Кнопки в колонке «Действия»: активация, редактирование, удаление. Для горизонтальной прокрутки зажмите Alt и прокрутите колёсико мыши.</p>
